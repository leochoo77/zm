...
program_version_link="https://raw.githubusercontent.com/leochoo77/zm/main/onekey-install-shell-master/frps/version.sh"
str_install_shell=https://raw.githubusercontent.com/leochoo77/zm/main/onekey-install-shell-master/frps/install-frps.sh
shell_update(){
    fun_clangcn "clear"
