...
program_version_link="https://github.com/leochoo77/zm/blob/main/onekey-install-shell-master/frps/version.sh"
str_install_shell=https://github.com/leochoo77/zm/blob/main/onekey-install-shell-master/frps/install-frps.sh
shell_update(){
    fun_clangcn "clear"
